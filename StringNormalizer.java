public String normalize(String input)
	...
	normalizedString = normalizedString.replaceAll("([^\u1040-\u1049])\u1040([^\u1040-\u1049\u0020]|[\u104a\u104b])", "$1\u101D$2");
        ...
        //seven and ra
	normalizedString = normalizedString.replaceAll("(\u1047)( ? = [\u1000 - \u101C\u101E - \u102A\u102C\u102E - \u103F\u104C - \u109F\u0020])", "\u101B");
	normalizedString = normalizedString.replaceAll("\u1031\u1047", "\u1031\u101B");

        normalizedString=normalizedString.replaceAll("([\u1000-\u1021])(\u1036)(\u103D)(\u1037)","$1$3$2$4"); // For the case of ဖံွ့ဖြိုး

        normalizedString=normalizedString.replaceAll("([\u1000-\u1021])(\u102D)(\u1039)([\u1000-\u1021])", "$1$3$4$2"); // အိနိ္ဒယ reorder
        normalizedString=normalizedString.replaceAll("([\u1000-\u1021])(\u1036)(\u103E)","$1$3$2");
        normalizedString=normalizedString.replaceAll("\u1037\u102F", "\u102F\u1037"); //reorder Sign U and auk myint
        normalizedString=normalizedString.replaceAll("\u1036\u103D", "\u103D\u1036"); //reorder Sign Wa and  ANUSVARA
        normalizedString=normalizedString.replaceAll("(\u1004)(\u1031)(\u103A)(\u1039)([\u1000-\u1021])", "$1$3$4$5$2"); //reorder for သင်္ဘော
        normalizedString=normalizedString.replaceAll("(\u102D)(\u103A)+", "$1"); //type error
        normalizedString=normalizedString.replaceAll("\u1025\u103A", "\u1009\u103A");// fix nya lay that and Sign U
